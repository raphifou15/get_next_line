...
/**
 * @brief Duplique une chaîne de caractères jusqu'à la première occurrence d'un retour à la ligne.
 * 
 * Cette fonction alloue de la mémoire pour une nouvelle chaîne de caractères qui est une copie
 * de la chaîne d'entrée, en s'arrêtant avant le premier caractère de retour à la ligne.
 * 
 * @param s La chaîne de caractères d'entrée.
 * @return Une nouvelle chaîne de caractères qui est une copie de la chaîne d'entrée, en s'arrêtant avant le premier caractère de retour à la ligne.
 */
...
/**
 * @brief Modifie une chaîne de caractères en supprimant une partie de la chaîne.
 * 
 * Cette fonction crée une nouvelle chaîne de caractères en copiant une partie
 * de la chaîne d'entrée, en commençant à un certain index et en copiant
 * une certaine longueur. La fonction libère la mémoire allouée à la chaîne d'entrée.
 * 
 * @param s La chaîne de caractères d'entrée.
 * @param start L'index de départ de la copie.
 * @param len La longueur de la partie à copier.
 * @param i L'index du dernier caractère de la chaîne d'entrée (facultatif).
 * @return Une nouvelle chaîne de caractères qui est une copie de la partie de la chaîne d'entrée spécifiée.
 */
...
/**
 * @brief Extrait la première ligne d'une chaîne de caractères et met à jour le reste.
 * 
 * Cette fonction extrait la première ligne d'une chaîne de caractères, en la stockant
 * dans une nouvelle chaîne de caractères et en mettant à jour la chaîne d'entrée
 * pour ne contenir que le reste.
 * 
 * @param reste La chaîne de caractères d'entrée.
 * @param line Pointeur vers la nouvelle chaîne de caractères qui contiendra la première ligne.
 * @return La chaîne d'entrée, mise à jour pour ne contenir que le reste.
 */
 ...
 * 
 * Cette fonction libère la mémoire allouée à une chaîne de caractères et
 * affecte la valeur NULL au pointeur vers la chaîne de caractères.
 * 
...
/**
 * @brief Lit une ligne de texte depuis un fichier.
 * 
 * Cette fonction lit une ligne de texte depuis un fichier et la stocke
 * dans une nouvelle chaîne de caractères.
 * 
 * @param fd Le descripteur de fichier du fichier à lire.
 * @param line Pointeur vers la nouvelle chaîne de caractères qui contiendra la ligne lue.
 * @return 1 si une ligne a été lue, 0 si la fin du fichier a été atteinte, -1 en cas d'erreur.
 */
