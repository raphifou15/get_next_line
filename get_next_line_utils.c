 ...
 * @brief Fonctions utilitaires pour get_next_line.
 */

/**
 * @brief Duplique une chaîne de caractères.
 * 
 * Alloue de la mémoire pour une nouvelle chaîne de caractères et copie
 * le contenu de la chaîne d'entrée dans la nouvelle chaîne.
 * 
 * @param[in] s Chaîne de caractères à dupliquer.
 * @return Pointeur vers la nouvelle chaîne de caractères, ou NULL en cas d'erreur.
 */
 ...
 * 
 * Cette fonction calcule la longueur d'une chaîne de caractères, avec
 * l'option de s'arrêter à un caractère de retour à la ligne ('\n').
 * 
 * @param[in] s Chaîne de caractères à analyser.
 * @param[in] carriage Indique si la fonction doit s'arrêter au caractère de retour à la ligne (1) ou non (0).
 * @return Longueur de la chaîne, ou la position du caractère de retour à la ligne si `carriage` est à 1.
 */
 ...
 * 
 * Cette fonction recherche la première occurrence d'un caractère donné
 * dans une chaîne de caractères.
 * 
 * @param[in] s Chaîne de caractères à analyser.
 * @param[in] c Caractère à rechercher.
 * @return Pointeur vers la première occurrence du caractère dans la chaîne,
 ...
 * 
 * Alloue de la mémoire pour une nouvelle chaîne de caractères, copie
 * les contenus des deux chaînes d'entrée dans la nouvelle chaîne, puis
 * libère la mémoire de la première chaîne d'entrée.
 * 
 * @param[in] s1 Première chaîne de caractères à concaténer.
 * @param[in] s2 Deuxième chaîne de caractères à concaténer.
 * @return Pointeur vers la nouvelle chaîne de caractères, ou NULL en cas d'erreur.
 */
 ...
 * libère la mémoire de la chaîne d'entrée et retourne un pointeur vers
 * la nouvelle chaîne.
 * 
 * @param[in] s Chaîne de caractères d'entrée (sera libérée).
 * @return Pointeur vers la nouvelle chaîne de caractères vide, ou NULL en cas d'erreur.
 */
char	*ft_str(char *s)
{
	char	*str;
